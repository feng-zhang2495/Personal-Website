        ...
        <main className='hero h-screen w-screen'>
            <div className='flex flex-row pt-44 px-32 justify-between'>
                <div className='left-hero basis-3/6 flex flex-col items-start'>
                    ...
                    <h5 className='text-lg pt-4'>Hello, I'm a first year CS student at the University of Waterloo. I'm deeply passionate in all fields surrounding web development and Machine Learning, and I am constantly looking for new opportunities to improve my skills!</h5>
                </div>
